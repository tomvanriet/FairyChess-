...
public class BoardValidationErrors {
     ...
     *
     * @param line The line number of the invalid allocation.
     */
     ...
     *
     * @param file The file component of the chess notation (the d in d6)
     * @param rank The rank component of the chess notation (the 6 in d6)
     */
     ...
     *
     * @param line The line number of the status line
     */
     ...
     *
     * @param line  The line number of the status line
     * @param index The index of the castling opportunity
     */
